...
BIN2        EQU     07h
; --------------------------------------
SAFE_DUTY   EQU     D'170'  ; safty duty for eneloop
...
PHOTB       EQU     01h     ; RIGHT
; --------------------------------------
BW_TH       EQU     D'80'  ; black-white threshold
...
LCD_write
    ...
    CALL   wait50us     ; don't use busy wait
    RETURN
...
LCD_command
    ...
    CALL    wait1ms     ; don't use busy wait
    CALL    wait1ms     ; wait 1.64ms
    RETURN
